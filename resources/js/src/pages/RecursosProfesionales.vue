...
import {ref} from "vue";
import IconCustom from "@/src/components/IconCustom.vue";
...
<template>
    <main-layout>
        ...
        <div class="flex flex-col items-center bg-gray-50">
                ...
                <div class="flex flex-col gap-6">
                    ...
                    <span class="text-lg lg:text-xl font-medium text-gray-800">
                        {{ $t(item.preguntaKey) }}
                                ...
                                <span
                                    class="text-2xl text-[#657d88] transition-transform duration-300"
                                    :class="{ 'rotate-45': activeFaq === item.id }"
                                >
                        +
                    </span>
                            </button>
            ...
            <!-- Document cards. Hidden until the linked files are fixed;
                 may move back above the FAQs later. -->
            <div v-if="false" class="w-full grid lg:grid-cols-5 gap-5 px-5 py-5 lg:py-12 lg:px-0 lg:max-w-[1150px]">
