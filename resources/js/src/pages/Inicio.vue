        ...
        modal: [
            {
                ...
                details_p: t('ini_val_dp1') + "\n" + "\n" + t('ini_val_dp2') + "\n" + "\n" + t('ini_val_dp3'),
                details_p2: t('ini_val_ep1') + "\n" + "\n" + t('ini_val_ep2') + "\n" + "\n" + t('ini_val_ep3'),
                img_p: "valise1.jpeg",
                imgs: [
                    "valise2.jpeg",
                    "valise3.jpeg",
...
onMounted(() => {
    ...
    observerBanner = new IntersectionObserver(
        ([entry]) => {
            const el = videoBanner.value;
            if (!el) return;
    ...
    if (videoBanner.value) {
        observerBanner.observe(videoBanner.value);
    }
...
onBeforeUnmount(() => {
    ...
    if (observerBanner && videoBanner.value) {
        observerBanner.unobserve(videoBanner.value);
    }
...
<template>
   ...
   <main-layout>
       <!-- 1 -->
       <div class="relative flex h-[250px] md:h-[300px] lg:h-[480px] justify-center">
           ...
           <div class="absolute inset-0 bg-gradient-to-tr from-[black] to-transparent opacity-90"></div>
       ...
       <!-- 2 -->
       <div class="mt-[4vh] mb-[4vh] bg-white flex justify-center px-5 pt-[2vh] pb-[2vh] lg:px-0">
           <div class="flex flex-col w-full justify-between items-center gap-3 lg:gap-5 lg:flex-row lg:max-w-[1150px]">
               <h2 class="flex-2/5 text-[1.7rem] italic text-[#918164] tracking-wider lg:text-[2.5rem]"> {{ $t('ini_confian') }} </h2>
               <div class="flex-3/5 flex justify-center w-full gap-5  lg:gap-15">
                   <div class="flex-1/3 flex items-center justify-center">
                       <img class="object-contain w-20 md:w-[100px] lg:w-[120px] opacity-50" src="../assets/media/ritz.png" alt="ritz" title="ritz">
                   </div>
                   <div class="flex-1/3 flex items-center justify-center">
                       <img class="object-contain md:w-[150px] lg:w-[180px] opacity-50" src="../assets/media/valise.png" alt="valise" title="valise">
                   </div>
                   <div class="flex-1/3 flex items-center justify-center">
                       <img class="object-contain md:w-[150px] lg:w-[180px] opacity-50" src="../assets/media/rosewood.jpg" alt="rosewood" title="rosewood">
                   </div>
               </div>
           </div>
       </div>
       ...
       <div id="productos" class=" flex justify-center bg-[#f7f7f7]">
           <div class="w-full flex flex-col px-2 py-3 gap-3 items-center justify-center lg:justify-start lg:items-start lg:gap-10 lg:py-8 lg:max-w-[1150px]">
               <h2 class="font-light italic tracking-wider text-[1.7rem] lg:text-[2.5rem]"> {{ $t('ini_sub1') }} </h2>
               <div class="flex gap-5 px-5 lg:px-5">


                   <div class="w-full flex flex-col gap-5 lg:flex-row lg:gap-10 lg:h-[500px]">
                       <router-link to="/puertas" class="w-full h-[150px] flex flex-col group lg:w-1/3 lg:h-full">
                           ...
                           <div class="hidden lg:flex lg:flex-col">
                               ...
                               <router-link
                                   ...
                                   to="">{{ $t('ini_descubrir') }}</router-link>
                           </div>
                       </router-link>
                       ...
                       <div class="w-full flex flex-col gap-5 cursor-pointer lg:gap-10 lg:w-1/3 lg:h-full">
                           <div>
                               ...
                               <div class="hidden lg:flex lg:flex-col">
                                   <p class=" group-hover:text-[#918164] lg:text-[1.3rem]"> {{ $t('ini_maderas') }} </p>
                               </div>
                           </div>
                           <div class="flex-1 justify-start items-center">
                               <p class="text-base text-justify lg:text-left lg:text-lg">{{ $t('ini_p1') }}</p>
                           </div>
       ...
       <!-- 4 -->
       <div class="mt-[4vh] mb-[4vh] bg-white flex justify-center pt-[5vh] pb-[5vh] h-[180px] lg:h-[180px] md:p-5 md:h-[180px]">
           <div class="flex flex-col w-full items-center gap-3 px-2  lg:gap-5 lg:px-0 lg:flex-row lg:max-w-[1150px]">
               <h2 class="text-[1.7rem] italic text-[#918164] tracking-wider font-light lg:flex-2/5 lg:text-[2.5rem]"> {{ $t('ini_cer') }} </h2>
               <transition name="fade" mode="out-in">
                   <div class="flex justify-center items-center w-full gap-5 lg:justify-start lg:flex-3/5 flex-gap-15">
                       <div class="flex-1/4 flex justify-center items-center">
                           <img class="object-contain w-15 lg:w-[110px]" src="../assets/media/warm.png" alt="warm" title="Warm">
                       </div>
                       <div class="flex-1/4 flex justify-center items-center">
                           <img class="object-contain w-15 lg:w-[140px]" src="../assets/media/esg.png" alt="esg" title="Esg">
                       </div>
                       <div class="flex-1/4 flex justify-center items-center">
                           <img class="object-contain w-15 lg:w-[80px]" src="../assets/media/fsc.png" alt="fsc" title="Fsc">
                       </div>
       ...
       <div class="flex flex-col-reverse ">
           ...
           <div class="pt-[4vh] pb-[4vh] hidden justify-center bg-[#f7f7f7]">
               <div class="flex flex-col w-full max-w-[1150px] gap-10">
                   <h2 class="font-light italic tracking-wider lg:text-[2.5rem]"> {{ $t('ini_sub2') }} </h2>
                   <div class="h-[500px] bg-white rounded-xl shadow-md">
                       <div class="flex h-full">
                           <div class="flex-1/4 flex flex-col lg:py-10 lg:pl-8">
                               <div class="flex-1/2">
                                   <div>
                                       <h3 class="text-[#918164] font-bold">{{ $t('ini_ventanas').toUpperCase() }}</h3>
                                       <div class="h-[3px] bg-[#918164]"></div>
                                   </div>
                                   <div class="flex flex-col mt-2">
                                       <div v-for="item in ventanas" :key="item.id" @click="() => {
                                    ...
                                    indexSelect = item.id
                                            ...
                                            :class="{ 'bg-[#e6e9ee] rounded-l-full': indexSelect === item.id }">
                                           <div class=" w-2 h-2 rounded-full"
                                                :class="{ 'bg-[#918164]': indexSelect === item.id }" />
                               ...
                               <div class="flex-1/2">
                                   <div>
                                       <h3 class="text-[#918164] font-bold">{{ $t('ini_puertas').toUpperCase() }}</h3>
                                       <div class="h-[3px] bg-[#918164]"></div>
                                   </div>
                                   <div class="flex flex-col mt-2">
                                       <div v-for="item in puertas" :key="item.id" @click="() => {
                                    itemSeleccionado = item
                                    imagenActual = item.cerrada
                                    indexSelect = item.id
                                }" class="flex justify-start w-full pl-5 pt-2 pb-2 items-center gap-3 cursor-pointer hover:bg-[#e6e9ee] hover:rounded-l-full"
                           ...
                           <div class="flex-3/4 flex bg-[#E6E9EE] rounded-xl p-10">
                               <div class="flex-1 flex gap-10 items-center">
                                   <div v-if="itemSeleccionado" class="flex-1/2 h-full w-full">
                                       <img class="w-full h-full object-contain transition-all duration-200 ease-in-out"
                                            :src="imagenActual" :alt="itemSeleccionado.name"
                                            @mouseover="imagenActual = itemSeleccionado.abierta"
                                            @mouseleave="imagenActual = itemSeleccionado.cerrada" :title="itemSeleccionado.name" />
                                   </div>

                                   <div v-if="itemSeleccionado" class="flex-1/2 flex flex-col gap-5">
                                       <div>
                                           <h4 class="text-[#918164] font-bold">{{ itemSeleccionado.name.toUpperCase() }}</h4>
                                           <div class="h-[3px] bg-[#918164]"></div>
                                       </div>
                                       <div class="w-full h-[180px]">
                                           <p class="text-justify">{{ itemSeleccionado.des }}</p>
                                       </div>
                                       <router-link
                                           class="bg-[#2B5A51] w-fit text-white p-3 rounded-xl transition-normal duration-300 ease-in-out hover:shadow-xl"
                                           :to="{ name: 'configd', query: { tipo: itemSeleccionado.key } }"> {{ $t('ini_div')
                                           }} {{
           ...
           <div class="mt-[4vh] mb-[4vh] bg-white flex justify-center pt-[2vh] pb-[2vh]">
               <div class="flex flex-col w-full px-2 items-center lg:gap-5 md:gap-5 md:max-w-[1000px] lg:max-w-[1150px] lg:flex-row">
                   ...
                   <div class="flex gap-5 lg:flex-3/5 lg:gap-15  md:w-[100%]">
                       ...
                       <div class="flex-1/4 flex items-center justify-center"><img class="object-contain w-15 lg:w-[80px]" src="../assets/media/cuatro44.jpg" alt="cuatro44" title="Cuatro444"></div>
                       <div class="flex-1/4 flex items-center justify-center"><img class="object-contain w-15 lg:w-[80px]" src="../assets/media/beck.jpg" alt="beck" title="Beck"></div>
           ...
           <div class="pt-[4vh] pb-[4vh] flex justify-center bg-[#f7f7f7]">
               <div class="w-full max-w-[1150px] flex flex-col px-2 gap-5 lg:gap-10 lg:px-0">
                   <h2
                   ...
                   <div class="px-5 lg:px-0">
                       <div class="flex flex-col gap-5 lg:hidden">
                           <div
                               ...
                               class="relative bg-black cursor-pointer overflow-hidden rounded-xl
                 w-full h-[200px]
                 ...
                 hover:-translate-y-2 hover:shadow-xl"
                           >
                               <img
                                   ...
                                   :title="item.name_p"
                               >
                               <p class="etiqueta-flotante font-light tracking-wider">
                                   {{ item.name_p }}
                               </p>
                           </div>
                       </div>
                       ...
                       <div class="relative hidden lg:block">
                           ...
                           <button
                               ...
                               @click="prevSlide"
                               :disabled="!canPrev"
                               class="hidden lg:flex items-center justify-center absolute left-[-2.5rem] top-1/2 -translate-y-1/2 p-1.5 rounded-full bg-[#918164] opacity-70 text-white cursor-pointer transition-opacity ease-in-out duration-300 hover:opacity-100 disabled:opacity-0"
                           >
                           ...
                           <button
                               ...
                               @click="nextSlide"
                               :disabled="!canNext"
                               class="hidden lg:flex items-center justify-center absolute right-[-2.5rem] top-1/2 -translate-y-1/2 p-1.5 rounded-full bg-[#918164] opacity-70 text-white cursor-pointer transition-opacity ease-in-out duration-300 hover:opacity-100 disabled:opacity-0"
                           >
                           ...
                           <!-- Carrusel desktop -->
                           <div
                               class="flex flex-row flex-nowrap gap-5
                 h-[150px] lg:h-[420px]"
                           >
                               <div
                                   ...
                                   @click="openM(item, 'normal')"
                                   class="relative bg-black cursor-pointer overflow-hidden rounded-xl
                   shrink-0 basis-[calc((100%-3*1.25rem)/4)]
                   h-full
                   transition-transform transition-shadow duration-300 ease-in-out
                   hover:-translate-y-3 hover:shadow-xl"
                               >
                                   <p v-if="item.et_nuevo" class="absolute right-2 top-2 bg-white rounded-lg font-bold px-2 opacity-70">
                                       {{$t('ini_et_nuevo')}}
                                   </p>
                                   ...
                                   <img
                                       ...
                                       :title="item.name_p"
                                   >
                                   <p class="etiqueta-flotante font-light leading-10 tracking-wider">
                                       {{ item.name_p }}
                                   </p>
                               </div>
                           </div>
                   ...
                   <div class="flex flex-col gap-4 items-center">
                       ...
                       <div class="h-[1px] bg-black w-75 lg:w-full md:w-[80%] lg:max-w-[575px]"></div>
                   </div>
               </div>
           </div>
       ...
       <div class="pt-[4vh] pb-[4vh] bg-[#f7f7f7] flex justify-center">
           <div class="w-full px-5 flex flex-col gap-5 lg:gap-8 lg:max-w-[1150px] lg:px-0">
               <h2 class="text-[1.7rem] text-center leading-none font-light italic tracking-wider lg:text-left lg:text-[2.5rem]">{{ $t('ini_sub4') }}</h2>
               <div class="flex flex-col-reverse lg:flex-row lg:gap-[2vw]">
                   <div class="flex-1/2 p-2">
                       <div class="rounded-[40px] overflow-hidden h-full">
                           ...
                           <video ref="video" class="h-full w-full object-cover" :src="video_src" playsinline muted
                                  preload="auto"></video>
                       </div>
                   </div>
                   <div class="flex-2/3 flex flex-col gap-[2vh] pt-[3vh] pb-[3vh]">
                       <p class="text-base flex-1/2 whitespace-pre-line text-justify lg:text-left lg:text-lg">
                           {{ $t('ini_p7') + "\n\n" + $t('ini_p8') }}
                       </p>
                       <div class="flex-1/2 flex flex-col gap-3 lg:gap-10">
                           ...
                           <div class="grid grid-cols-2 md:grid-cols-4 lg:flex">
                               ...
                               <div class="flex-1/4 flex flex-col justify-center items-center gap-5">
                                   <img class="w-15 lg:w-[3.5vw]" src="../assets/media/icons/icon-lujo.png" alt="icon-lujo" title="Lujo">
                                   <p>{{ $t('ini_p11') }}</p>
                               </div>
                               <div class="flex-1/4 flex flex-col justify-center items-center gap-5">
                                   <img class="w-15 lg:w-[3.5vw]" src="../assets/media/icons/icon-seg.png" alt="icon-seg" title="Seg">
                                   <p>{{ $t('ini_p12') }}</p>
                               </div>
                               <div class="flex-1/4 flex flex-col justify-center items-center gap-5">
                                   <img class="w-15 lg:w-[3.5vw]" src="../assets/media/icons/icon-tran.png" alt="icon-tran" title="Tran">
                                   <p>{{ $t('ini_p13') }}</p>
                               </div>
                           </div>
                       </div>
               ...
               <div class="hidden gap-[2vw] h-[350px] lg:flex">
                   <div class="flex-1/4 rounded-xl overflow-hidden duration-300 ease-in-out hover:brightness-90">
                       <img class="object-cover w-full h-full" src="../assets/media/nosotros_ventana.jpeg"
                            alt="nosotros_ventana">
                   </div>
                   <div class="flex-1/4 rounded-xl overflow-hidden duration-300 ease-in-out hover:brightness-90">
                       <img class="object-cover w-full h-full" src="../assets/media/nosotros_interior.jpeg"
                            alt="nosotros_interior">
                   </div>
                   <div class="flex-1/4 rounded-xl overflow-hidden duration-300 ease-in-out hover:brightness-90">
                       <img class="object-cover w-full h-full" src="../assets/media/nosotros_exterior.jpeg"
                            alt="nosotros_exterior">
                   </div>
                   <div class="flex-1/4 rounded-xl overflow-hidden duration-300 ease-in-out hover:brightness-90">
                       <img class="object-cover w-full h-full" src="../assets/media/nosotros_puerta.jpg"
                            alt="nosotros_puerta">
                   </div>
               </div>
           </div>
       ...
       <div class="flex justify-center py-5 lg:py-10 bg-[#fcfcfc]">
           <div class="w-full px-5 gap-5 lg:max-w-[1150px] flex flex-col lg:gap-2 lg:px-0 lg:flex-row">
               <div class="flex flex-col gap-2 lg:flex-1/3 lg:gap-10 lg:mt-10">
                   <h2 class="text-center leading-none text-[1.7rem] font-light italic tracking-wider lg:text-left lg:text-[2.5rem]">{{ $t('ini_sub5') }}</h2>
                   <p class="text-base text-justify lg:text-left">{{ $t('ini_p14') }}</p>
               </div>
               <div class="flex gap-3 lg:gap-10 lg:flex-2/3">
                   <div class="flex flex-col flex-1/2 gap-y-5">
                       <div class="flex-1 rounded-xl overflow-hidden">
                           <img class="object-cover w-full h-full" src="../assets/media/puerta.gif">
                       </div>
                       <div class="flex flex-col justify-center items-center lg:justify-start lg:items-start gap-5">
                           <router-link
                               class="bg-[#2B5A51] w-fit text-white text-sm p-3 lg:text-base lg:p-3 rounded-xl transition-normal duration-300 ease-in-out hover:translate-y-[-10px] hover:shadow-xl"
                               to="/puertas">{{ $t('ini_p15') }} {{ $t('ini_puerta')
                               }}</router-link>
                       </div>
                   </div>
                   <div class="flex flex-col flex-1/2 gap-y-5">
                       <div class="flex-1 overflow-hidden rounded-xl">
                           <img class="object-cover w-full h-full" src="../assets/media/ventana.gif">
                       </div>
                       <div class="flex flex-col gap-5 items-center justify-center lg:items-start lg:justify-start">
                           <router-link
                               class="bg-[#2B5A51] w-fit text-white text-sm p-3 lg:text-base lg:p-3 rounded-xl transition-normal duration-300 ease-in-out hover:translate-y-[-10px] hover:shadow-xl"
                               to="/ventanas">{{ $t('ini_p15') }} {{ $t('ini_ventana')
                               }}</router-link>
                       </div>
                   </div>
               </div>
       ...
       <div class="flex justify-center relative bg-contacto bg-cover bg-center bg-fixed p-5 lg:px-0">
           <div class="absolute inset-0 bg-white opacity-80"></div>


           <div class="flex flex-col relative w-full gap-5 lg:flex-row lg:max-w-[1150px] lg:pt-8 lg:pb-8 lg:gap-x-5">
               <div class="flex-1/2 relative lg:pt-8 flex flex-col gap-4">
                   <p class="text-[2.5rem] leading-none text-[#918164] font-light italic text-center lg:text-[3rem] lg:text-left"> {{ $t('ini_sub7') }} </p>
                   <h4 class="text-[1.7rem] text-center font-light italic tracking-wider leading-none lg:text-left lg:text-[2.2rem]">{{ $t('ini_p19') }}</h4>
                   <h4 class="text-[1.7rem] text-center font-light italic tracking-wider leading-none lg:text-left lg:text-[2.2rem]">{{ $t('ini_p20') }}</h4>
               </div>
               <div
                   ...
                   <form class="flex flex-col w-full gap-5" action="">
                       ...
                       <input name="email" class="pt-2 pb-2 pl-4 pr-4 rounded-xl bg-[#EBEDEE] rounded-borders"
                              :placeholder="$t('f_correo')" required>
                       <textarea class="pt-2 pb-2 pl-4 pr-4 rounded-xl bg-[#EBEDEE] rounded-borders min-h-[120px]"
                                 :placeholder="$t('f_msg')" required></textarea>
                       <div>
                       ...
                       <div class="flex justify-start">
                           <button
                               class="bg-[#275A50] text-white rounded-lg py-1.5 px-5 lg:pl-[4vw] lg:pr-[4vw] lg:pt-1 lg:pb-1 cursor-pointer transition-colors duration-300 hover:text-white hover:bg-[#568a64] ">
                               {{ $t('f_enviar') }}
                           </button>
                       </div>
                   </form>
       ...
       <!--Modal Detalles-->
       <div v-if="activeModal === 'normal'"
            class="fixed z-50 inset-0 bg-[rgba(0,0,0,0.2)] overflow-y-auto flex justify-center px-2 py-8 lg:px-0" @click.self="closeM">
           <div class="w-full h-max lg:max-w-[1150px] lg:p-8 bg-white rounded-xl flex flex-col gap-3 lg:gap-10 shadow-xl">
               ...
               <div class="w-full px-5 lg:px-10 flex flex-col gap-8 lg:gap-15">
                   ...
                   <div class="w-full flex flex-col gap-3 lg:flex-row lg:gap-10">
                       <div class="flex-1/2 flex flex-col border-b-2 lg:border-b-0 lg:border-e-2 border-[#918164]">
                           <h2 class="text-[1.7rem] font-light text-[#918164] lg:text-[3.8rem]"> {{ itemModal[0].titulo }} </h2>
                           <p class="italic lg:text-lg"> {{ itemModal[0].ubi }} </p>
                       </div>
                       <div class="flex-1/2 flex justify-center items-center">
                           <p class="italic tracking-wider text-[#918164] lg:text-[1.5rem]"> {{ itemModal[0].subt
                               }}
                           </p>
                       </div>
                   </div>
                   ...
                   <div class="w-full flex flex-col lg:flex-row lg:gap-10">
                       <div class="flex-1/2 w-full rounded-xl overflow-hidden lg:h-[280px]">
                           <img class="w-full h-full object-cover" :src="u_media + itemModal[0].img_p"
                                :alt="itemModal[0].img_p">
                       </div>
                       <div class="flex-1/2 flex flex-col gap-2 items-center justify-center">
                           <p class="italic tracking-wider text-[#918164] lg:text-[1.2rem]">
                               {{ itemModal[0].details_t }} </p>
                           <p class="whitespace-pre-line text-sm"> {{ itemModal[0].details_p }} </p>
                       </div>
                   </div>

                   <div class="w-full flex flex-col gap-5 lg:flex-row lg:h-[400px] group">
                       <div v-for="index in itemModal[0].imgs" :key="index"
                            class="flex-1 overflow-hidden rounded-xl transition-all duration-500 ease-in-out " :class="{
                            'lg:flex-[3]': hoveredImg === index,
                            'lg:flex-[1]': hoveredImg && hoveredImg !== index,
                            'lg:flex-[2]': !hoveredImg
                        }" @mouseenter="hoveredImg = index" @mouseleave="hoveredImg = null">
                           <img class="w-full h-[150px] object-cover transition-transform duration-500 lg:h-full" :src="u_media + index"
                                :alt="index">
                       </div>
                   </div>
                   ...
                   <div class="w-full">
                       <p class="whitespace-pre-line lg:text-sm"> {{ itemModal[0].details_p2 }} </p>
                   </div>


                   <div v-if="itemModalId === 4" class="w-full border mb-5 p-5 rounded-xl border-[#918164] flex flex-col gap-5 lg:gap-10 lg:flex-row lg:m-0">
                       <div class="flex-3/4">
                           <p class="text-center text-[#918164] lg:text-left lg:text-[1.5rem]">{{ $t('ini_p5') }}</p>
                           <p class="text-justify italic lg:text-left lg:text-[1.5rem]">{{ $t('ini_p6') }}</p>
                       </div>
                       <div class="flex-1/4 flex justify-center items-center lg:pr-15">
                           <button
                               class="font-bold w-full p-2 bg-[#275A50] text-center text-white rounded-full transition-normal duration-300 hover:translate-y-[-8px] lg:py-4 lg:px-5 cursor-pointer"
                               @click="openProyectsForm"> {{ $t('ini_btn3') }} </button>
                       </div>
                   </div>

                   <div v-else class="w-full border mb-5 p-5 rounded-xl border-[#918164] flex flex-col gap-5 lg:gap-10 lg:flex-row lg:m-0">
                       <div class="flex-3/4">
                           <p class="text-[#918164] lg:text-[1.5rem]">{{ $t('ini_p3') }}</p>
                           <p class="italic lg:text-[1.5rem]">{{ $t('ini_p4') }}</p>
                       </div>
                       <div class="flex-1/4 flex justify-center items-center lg:pr-15">
                           <button
                               class="font-bold w-full text-center p-2 bg-[#275A50] text-white rounded-full transition-normal duration-300 hover:translate-y-[-8px] lg:py-4 lg:px-5 cursor-pointer" @click="openProyectsForm"> {{ $t('ini_btn3') }} </button>
                       </div>
                   </div>
       ...
       <!--Modal Maderas-->
       <div v-if="activeModal === 'woods'"
            class="fixed z-50 inset-0 bg-[rgba(0,0,0,0.2)] overflow-y-auto flex justify-center items-center px-2 py-8 lg:px-0"
            @click.self="closeM">
           <div class="w-full h-max lg:max-w-[1150px] p-8 bg-white rounded-xl flex flex-col gap-10 shadow-xl">
               <div class="w-full flex justify-end items-center">
                   <h2 class="flex-1 text-[#757575] text-[1.7rem]  lg:text-[2.5rem]">{{ $t('ini_accesorios') }}</h2>
                   <button @click="closeM"
                           class="border rounded-lg py-1 px-2 text-[#cccccc] leading-none cursor-pointer transition-colors duration-300 hover:text-[#918164] lg:text-[1.5rem]">X</button>
               </div>

               <div class="w-full lg:px-10 flex justify-center lg:gap-15">
                   <swiper class="h-[400px] w-full relative rounded flex justify-center items-center"
                           :modules="[Navigation, Pagination, Scrollbar, A11y, Zoom]" :pagination="{ clickable: true }"
                           :scrollbar="{ draggable: true }" :slides-per-view="1" :zoom="true" navigation>
                       <swiper-slide v-for="i in maderas" :key="i.id">
                           <div class="w-full h-full flex justify-center">
                               <div class="w-210 h-90 flex gap-10 ">
                                   <img :src="u_madera + i.img" :alt="`Slide ${i.id}`"
                                        class="flex-1/2 object-cover rounded-xl" />
                                   <div class="flex-1/2 flex flex-col justify-center">
                                       <h4 class="text-[#918164] text-[3rem] font-light leading-none">{{ i.name }}</h4>
                                       <div class="bg-[#918164] w-full h-1 rounded-xl mt-2"></div>
                                       <p class="mt-5 h-35 lg:text-[1.3rem]">{{ i.des }}</p>
                                   </div>
                               </div>
                           </div>
